	...
	return (
		<main id="1" className="bg-MidnightBlue text-white flex flex-row items-center justify-evenly pt-28 pb-4">
			...
			<div className="w-80">
				...
				<p className="text-lg">
					Iqbal, 19 years old Computer Science student who loves <span className="italic">Math</span> a lot. I love to learn something new, especially coding-math related and writing. My goals is to be an Artificial Intelligence
					Researcher.
				</p>
			</div>
		</main>
