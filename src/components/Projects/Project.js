...
const Project = () => {
    return (
        <main id="2" className="bg-MidnightBlue flex flex-col justify-center items-center pt-14 pb-5 text-white">
            ...
            <div className="w-[25rem] bg-Sapphire flex flex-col p-5 rounded-lg border-[1px] border-ResolutionBlue">
                ...
                <a href="https://iqbal-url-shortener.vercel.app/" target="_blank" className="font-bold text-lg text-center hover:text-gray-600">URL Shortener</a>
